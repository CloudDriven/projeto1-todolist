const handleTasks = () => {
    ...
    if (!form || !tasksContainer || !createdTasksBadge || !completedTasksBadge) return;
    ...
    const handleUpdateCreatedTaskBadges = () => {
