...
const handleTasks = () => {
    ...
    for (let taskIndex = 0; taskIndex < tasks.length; taskIndex++) {
        ...
        tasksContainer.insertAdjacentHTML(
            "beforeend", 
            `<li class="task-item ${task.completed ? ` completed` : ""}" id="task-item-${taskIndex}">
    ...
    const handleCreateNewTask = (e) => {
        ...
        tasksContainer.insertAdjacentHTML(
            ...
            `<li class="task-item" id="task-item-${tasks.length - 1}">
                <button class="completeTaskBtn" onclick="handleCompleteTask(${tasks.length - 1})">
                <!--- SVG CheckBox --->
                    <svg
                    class="uncompleted-icon" 
                    width="18" 
